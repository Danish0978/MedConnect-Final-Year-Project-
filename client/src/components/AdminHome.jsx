    ...
    const fetchStatsData = async () => {
      try {
        ...
        const [
          ...
          axios.get('/doctor/getallmydoctors', config),
          axios.get('/appointment/getallappointments', config),
          axios.get('/doctor/applications', config),
          axios.get('/receptionist/get-receptionists', config)
        ]);
        ...
        setStatsData({
          ...
          activeAppointments: appointmentsRes.data?.filter(
            appt => appt.status.toLowerCase() === 'pending'
          )?.length || 0,
          pendingApplications: applicationsRes.data.data?.filter(
            app => app.status === 'pending'
          )?.length || 0,
          receptionists: receptionistsRes.data.data?.length || 0,
          loading: false,
          error: null
        });
...
setActivities(newActivities.sort((a, b) => new Date(b.time) - new Date(a.time)).slice(0, 5));
...
fetchStatsData();
  ...
  const stats = [
    {
      title: "Total Doctors",
      value: statsData.loading ? "..." : statsData.totalDoctors.toString(),
    ...
    },
    {
      ...
      value: statsData.loading ? "..." : statsData.activeAppointments.toString(),
    ...
    },
    {
      ...
      value: statsData.loading ? "..." : statsData.pendingApplications.toString(),
      icon: <Inbox size={24} />,
      iconBg: "#fef3c7",
      iconColor: "#d97706",
      barColor: "#d97706",
    ...
    {
      title: "Receptionists",
      value: statsData.loading ? "..." : statsData.receptionists.toString(),
      icon: <Users size={24} />,
      iconBg: "#f3e8ff",
      iconColor: "#9333ea",
      barColor: "#9333ea",
  ...
  const quickActions = [
    ...
    {
      href: "/dashboard/receptionists/add",
        ...
        <div className="chart-card animate-slide-up">
          <div className="chart-header">
            ...
            <div className="chart-actions">
              ...
              <button className="view-all-button" onClick={() => navigate('/dashboard/appointments')}>
        ...
        <div className="chart-card animate-slide-up">
          <div className="chart-header">
            ...
            <div className="chart-actions">
              ...
              <button className="view-all-button" onClick={() => navigate('/dashboard/doctors')}>
                View All <ChevronRight size={16} />
              </button>
            </div>
          </div>
